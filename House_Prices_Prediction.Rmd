...
### Inputs
```{r}
sliderInput("allQual", label = h5("Overall quality"),  value = 6, min = 1, max = 10)
...
sliderInput("extQual", label = h5("Exterior quality"), value = 3, min = 1, max = 5)
helpText("5-Excellent, 4-Good, 3-Average/Typical, 2-Fair, 1-Poor")
sliderInput("kitQual", label = h5("Kitchen quality"),  value = 3, min = 1, max = 5)
helpText("5-Excellent, 4-Good, 3-Average/Typical, 2-Fair, 1-Poor")
sliderInput("garCars", label = h5("Size of garage in car capacity"), value = 2, min = 0, max = 10)
```
