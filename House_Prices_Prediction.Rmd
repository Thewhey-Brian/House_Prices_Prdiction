...
numericInput("GrLiveArea", label = h5("Above grade (ground) living area square feet"), value = 1500)
...
numericInput("2stFlrSF", label = h5("Second Floor square feet "), value = 500)
...
```{r, eval=FALSE}
userinput <- reactive({
  df <- data.frame(input$OverallQual, input$Neighborhood, input$GrLivArea, input$ExterQual,
